  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-black/40 text-white">
        ...
        <Link href="/shop">
          <button className="mt-8 rounded-full border-2 border-white px-8 py-3 text-lg font-medium uppercase tracking-wider transition-all duration-300 hover:bg-white hover:text-black">
            Shop Now
          </button>
        </Link>
      </div>
